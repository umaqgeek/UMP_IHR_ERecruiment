                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="E-Advertisment/e-advertisment_ptj.html">E-Advertisement (PTJ)</a>
                            </li>
                            <li>
                                <a href="#!">E-Apply</a>
                            </li>
                            <li>
                                <a href="E-Filter/e-filter_ptj.html">E-Filter</a>
                            </li>
                            <li>
                                <a href="E-Test/e-Test.html">E-Test</a>
                            </li>
                            <li>
