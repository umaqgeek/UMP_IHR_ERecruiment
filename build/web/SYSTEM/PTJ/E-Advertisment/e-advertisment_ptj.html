						...
						<table class="table table-condensed" style="border-collapse:collapse;">
							...
							<tbody>
								<tr>
									...
									<td><a href="e-advertisment_ptj_setup.html" class="btn btn-info btn-sm" role="button"><i class="fa fa-file-text-o"></i></a></td>
								</tr>
								<tr>
									<td>2</td>
									<td>J41</td>
								...
								<table class="table table-condensed" style="border-collapse:collapse;">
									...
									<tbody>
										<tr>
											...
											<td><a href="e-advertisment_ptj_setup_sample1.html" class="btn btn-info btn-sm" role="button"><i class="fa fa-file-text-o"></i></a></td>
										</tr>
										<tr>
											<td>2</td>
											<td>FT41</td>
											...
											<td><a href="e-advertisment_ptj_setup_sample2.html" class="btn btn-info btn-sm" role="button"><i class="fa fa-file-text-o"></i></a></td>
										</tr>							
