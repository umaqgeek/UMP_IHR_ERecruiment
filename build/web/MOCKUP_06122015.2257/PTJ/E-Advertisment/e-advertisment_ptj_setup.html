            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
					 ...
					 <li class="active">
                        <a href="e-advertisement_ptj.html"><i class="fa fa-fw fa-file"></i>E-Advertisement (PTJ)</a>
                    </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <i class="fa fa-file"></i> <a href="e-advertisement_ptj.html">E-Advertisement</a>
                            </li>
							<li class="active">
