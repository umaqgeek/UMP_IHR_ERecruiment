    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">BPSM</a>
            </div>
            <!-- Top Menu Items -->
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            <li>
                                 <a href="e-iklan.html"><i class="fa fa-fw fa-file"></i> e-Iklan</a>
                            </li>
                        </ul>
                    </li>-->
                    <li>
                    ...
                    <li class="active">
                        <a href="javascript:;"data-toggle="collapse" data-target="#demo1"><i class="fa fa-fw fa-file"></i>  E-Advertisement <i class="fa fa-fw fa-caret-down"></i></a>
						<ul id="demo1" class="collapse">
							<li>
                                 <a href="e-advertisement_BPSM.html"><i class="fa fa-fw fa-file"></i> Main Setup</a>
                            </li>
                            <li>
                                 <a href="e-advertisement_BPSM_mini_setup.html"><i class="fa fa-fw fa-file"></i> Setup Gred & Name</a>
                            </li>
                        </ul>
					</li>
                </ul>
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
							...
							<li class="active">
							  ...
							  <li>
                                <i class="fa fa-file"></i><a href="e-advertisement_BPSM.html">E-Advertisement</a>
                            </li>
                            <li class="active">
               ...
               <div class="col-sm-12">E-Advertisement Setup (PTJ) <button type="button" style="float:right;" class="btn btn-primary btn-xs" data-toggle="collapse" data-target="#demo">Expand</button></div>
				...
				<div id="demo" class="collapse">
					   ...
					   <div class="row">
						   ...
						   <div class="col-sm-3"> 
								<div class="form-group">
									...
									<input type="text" style="background-color: #C0C0C0;" class="form-control" id="Grade" placeholder="Gred" Value="FT41" disabled>
								</div>
						   </div>
						   <div class="col-sm-3"> 
								<div class="form-group">
					   ...
					   <div class="row">
						   ...
						   <div class="col-sm-6"> 
								<div class="form-group">
									<label class="sr-only" for="Grade">PTJ</label>
									<input type="text" style="background-color: #C0C0C0;" class="form-control" id="Grade" placeholder="" value="Nama Jabatan" disabled>
								</div>
						   </div>
					   </div>
