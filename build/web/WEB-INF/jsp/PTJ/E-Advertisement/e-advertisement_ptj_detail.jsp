...
<ul>
    <li><a href="process.jsp?p=PTJ/E-Advertisement/e-advertisement_ptj.jsp">&lt;&lt; List Position from E-Warrant</a></li>
</ul>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select name="vpp_total_<%=i %>">
                            <% for (int j = 1; j <= Integer.parseInt(data1.get(i).get(8)); j++) { %>
