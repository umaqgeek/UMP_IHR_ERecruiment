    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="well">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>MESYURAT HR</td>
                                    <td>HARYANI, LILA</td>
                                    <!--Upon status changed either to accept or reject the hyperlink has to be disabled-->
                                    <td><a href="#">Accept</a><br/><a href="#" data-toggle="modal" data-target="#myReason">Reject</a></td>
                                    <td><a href="index.jsp?p=Candidate/E-Interview/PreInterviewStatus.jsp" target="_blank">Pre Interview</a><br/><a href="index.jsp?p=Candidate/E-Interview/InterviewStatus.jsp" target="_blank">Interview</a></td>
                                </tr>
                                <!--
                                <%
                ...
                <!-- Add/Edit DIV-->
                <div id="myReason" class="modal fade" role="dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">REASON TO REJECT</label>
                                        <div class="col-lg-4">
                                            <input type="text" id="txt_I_REASON" name="txt_I_REASON" value=""/>
                                        </div>
                                    </div>    
                                </div>
