!function() {
    ...
    (function() {
        function t(e) {
            ...
            var a = s.addEventListener, l = !1, h = !0, c = a ? "addEventListener" : "attachEvent", u = a ? "removeEventListener" : "detachEvent", d = a ? "" : "on";
        ...
        for (var n = window, r = n.setTimeout, s = document, o = s.documentElement, a = s.head || s.getElementsByTagName("head")[0] || o, l = "", h = s.scripts, c = h.length; --c >= 0; ) {
            var u = h[c], d = u.src.match(/^[^#?]*\/run_prettify\.js(\?[^#]*)?(?:#.*)?$/);
            if (d) {
                l = d[1] || "", u.parentNode.removeChild(u);
                break
            }
        }
        var p = !0, f = [], m = [], g = [];
        for (l.replace(/[&?]([^&=]+)=([^&]+)/g, function(e, t, i) {
            i = decodeURIComponent(i), t = decodeURIComponent(t), "autorun" == t ? p = !/^[0fn]/i.test(i) : "lang" == t ? f.push(i) : "skin" == t ? m.push(i) : "callback" == t && g.push(i)
        }), c = 0, l = f.length; l > c; ++c)
            (function() {
                var t = s.createElement("script");
                t.onload = t.onerror = t.onreadystatechange = function() {
                    !t || t.readyState && !/loaded|complete/.test(t.readyState) || (t.onerror = t.onload = t.onreadystatechange = e, --y, y || r(i, 0), t.parentNode && t.parentNode.removeChild(t), t = e)
                }, t.type = "text/javascript", t.src = "https://google-code-prettify.googlecode.com/svn/loader/lang-" + encodeURIComponent(f[c]) + ".js", a.insertBefore(t, a.firstChild)
            })(f[c]);
        for (var y = f.length, h = [], c = 0, l = m.length; l > c; ++c)
            h.push("https://google-code-prettify.googlecode.com/svn/loader/skins/" + encodeURIComponent(m[c]) + ".css");
        h.push("https://google-code-prettify.googlecode.com/svn/loader/prettify.css"), function(e) {
            function t(n) {
                if (n !== i) {
                    var r = s.createElement("link");
                    r.rel = "stylesheet", r.type = "text/css", i > n + 1 && (r.error = r.onerror = function() {
                        t(n + 1)
                    }), r.href = e[n], a.appendChild(r)
                }
            }
            var i = e.length;
            t(0)
        ...
        var v = function() {
            ...
            return function() {
                function i(e) {
                    ...
                    function n(e) {
                        var n = e.substring(1, e.length - 1).match(/\\u[\dA-Fa-f]{4}|\\x[\dA-Fa-f]{2}|\\[0-3][0-7]{0,2}|\\[0-7]{1,2}|\\[\S\s]|[^\\]/g), e = [], r = "^" === n[0], s = ["["];
                        r && s.push("^");
                ...
                function n(e, t) {
                    function i(e) {
                        ...
                        if (1 == l) {
                            ...
                            (3 == l || 4 == l) && (l = e.nodeValue, l.length && (l = t ? l.replace(/\r\n?/g, "\n") : l.replace(/[\t\n\r ]+/g, " "), r[a] = l, o[a << 1] = s, s += l.length, o[1 | a++ << 1] = e))
                    }
                ...
                function o(e) {
                    for (var t = void 0, i = e.firstChild; i; i = i.nextSibling)
                        var n = i.nodeType, t = 1 === n ? t ? e : i : 3 === n ? w.test(i.nodeValue) ? e : t : t;
                    return t === e ? void 0 : t
                }
                function a(t, n) {
                    function r(e) {
                        for (var t = e.e, i = [t, "pln"], h = 0, c = e.a.match(o) || [], d = {}, p = 0, f = c.length; f > p; ++p) {
                            var m, g = c[p], y = d[g], v = void 0;
                            if ("string" == typeof y)
                                m = !1;
                            else {
                                var b = a[g.charAt(0)];
                ...
                function l(t) {
                    ...
                    return(r = t.types) && n.push(["typ", r]), r = ("" + t.keywords).replace(/^ | $/g, ""), r.length && n.push(["kwd", RegExp("^(?:" + r.replace(/[\s,]+/g, "|") + ")\\b"), e]), i.push(["pln", /^\s+/, e, " \r\n	Â "]), r = "^.[^\\s\\w.$@'\"`/\\\\]*", t.regexLiterals && (r += "(?!s*/)"), n.push(["lit", /^@[$_a-z][\w$@]*/i, e], ["typ", /^(?:[@_]?[A-Z]+[a-z][\w$@]*|\w+_t\b)/, e], ["pln", /^[$_a-z][\w$@]*/i, e], ["lit", /^(?:0x[\da-f]+|(?:\d(?:_\d+)*\d*(?:\.\d*)?|\.\d\+)(?:e[+-]?\d+)?)[a-z]*/i, e, "0123456789"], ["pln", /^\\[\S\s]?/, e], ["pun", RegExp(r), e]), a(i, n)
                }
                function h(e, t, i) {
                    function n(e) {
                        var t = e.nodeType;
                    ...
                    for (var t = Math.max(0, 0 | t - 1) || 0, c = 0, d = h.length; d > c; ++c)
                        l = h[c], l.className = "L" + (c + t) % 10, l.firstChild || l.appendChild(a.createTextNode("Â ")), u.appendChild(l);
                    e.appendChild(u)
                }
                function c(e, t) {
                ...
                function u(e, t) {
                    return e && O.hasOwnProperty(e) || (e = /^\s*</.test(t) ? "default-markup" : "default-code"), O[e]
                }
                function d(e) {
                    var t = e.h;
                    try {
                        var i = n(e.c, e.i), r = i.a;
                        e.a = r, e.d = i.d, e.e = 0, u(t, r)(e);
                        var s = /\bMSIE\s(\d+)/.exec(navigator.userAgent), s = s && 8 >= +s[1], t = /\n/g, o = e.a, a = o.length, i = 0, l = e.d, h = l.length, r = 0, c = e.g, d = c.length, f = 0;
                        c[d] = a;
                        var m, g;
                        for (g = m = 0; d > g; )
                            c[g] !== c[g + 2] ? (c[m++] = c[g++], c[m++] = c[g++]) : g += 2;
                        for (d = m, g = m = 0; d > g; ) {
                            for (var y = c[g], v = c[g + 1], b = g + 2; d >= b + 2 && c[b + 1] === v; )
                                b += 2;
                            c[m++] = y, c[m++] = v, g = b
                        }
                        c.length = m;
                        ...
                        try {
                            for (; h > r; ) {
                                var C, w = l[r + 2] || a, S = c[f + 2] || a, b = Math.min(w, S), O = l[r + 1];
                ...
                var _ = p.PR = {createSimpleLexer: a, registerLangHandler: c, sourceDecorator: l, PR_ATTRIB_NAME: "atn", PR_ATTRIB_VALUE: "atv", PR_COMMENT: "com", PR_DECLARATION: "dec", PR_KEYWORD: "kwd", PR_LITERAL: "lit", PR_NOCODE: "nocode", PR_PLAIN: "pln", PR_PUNCTUATION: "pun", PR_SOURCE: "src", PR_STRING: "str", PR_TAG: "tag", PR_TYPE: "typ", prettyPrintOne: function(e, t, i) {
                        ...
                        function n() {
                            for (var i = p.PR_SHOULD_USE_CONTINUATION ? m.now() + 250 : 1 / 0; l.length > y && i > m.now(); y++) {
                                for (var s = l[y], c = S, u = s; u = u.previousSibling; ) {
                                    var f = u.nodeType, O = (7 === f || 8 === f) && u.nodeValue;
                                    if (O ? !/^\??prettify\b/.test(O) : 3 !== f || /\S/.test(u.nodeValue))
                                        break;
                                    if (O) {
                                        c = {}, O.replace(/\b(\w+)=([\w%+\-.:]+)/g, function(e, t, i) {
                                            c[t] = i
                                        });
                                        break
                                    }
                                ...
                                if (u = s.className, (c !== S || b.test(u)) && !L.test(u)) {
                                    for (f = !1, O = s.parentNode; O; O = O.parentNode)
                                        if (w.test(O.tagName) && O.className && b.test(O.className)) {
                                            f = !0;
                                            break
                                        }
                                    if (!f) {
                                        if (s.className += " prettyprinted", f = c.lang, !f) {
                                            var _, f = u.match(v);
                                            !f && (_ = o(s)) && C.test(_.tagName) && (f = _.className.match(v)), f && (f = f[1])
                                        }
                                        if (x.test(s.tagName))
                                            O = 1;
                                        else
                                            var O = s.currentStyle, E = a.defaultView, O = (O = O ? O.whiteSpace : E && E.getComputedStyle ? E.getComputedStyle(s, e).getPropertyValue("white-space") : 0) && "pre" === O.substring(0, 3);
                        ...
                        for (var s = i || document.body, a = s.ownerDocument || document, s = [s.getElementsByTagName("pre"), s.getElementsByTagName("code"), s.getElementsByTagName("xmp")], l = [], c = 0; s.length > c; ++c)
                            for (var u = 0, f = s[c].length; f > u; ++u)
                                l.push(s[c][u]);
                        var s = e, m = Date;
                        m.now || (m = {now: function() {
                                return+new Date
                            }});
                        var g, y = 0, v = /\blang(?:uage)?-([\w.]+)(?!\S)/, b = /\bprettyprint\b/, L = /\bprettyprinted\b/, x = /pre|xmp/i, C = /^code$/i, w = /^(?:pre|code|xmp)$/i, S = {};
                        n()
                    }};
