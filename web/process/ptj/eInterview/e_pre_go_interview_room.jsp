<%-- 
    Document   : e_pre_go_interview_room
    Created on : Mar 7, 2016, 4:36:39 PM
    Author     : Habib
--%>
...
String link_to_interview_room = "../../../process.jsp?p=PTJ/E-Interview/e_pre_interview_room.jsp"+and_is_refid+and_ipl_refid+sSize;
