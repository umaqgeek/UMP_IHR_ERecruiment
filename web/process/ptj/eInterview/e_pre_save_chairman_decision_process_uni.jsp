<%-- 
    Document   : e_pre_save_chairman_decision_process_uni
    Created on : Mar 26, 2016, 5:58:09 AM
    Author     : Habib
--%>
...
//    }
    ...
    response.sendRedirect("../../../process.jsp?p=PTJ/E-Interview/e_pre_chairman_start_uni.jsp&is_refid="+is_refid+"&icl_refid="+icl_refid);
%>
