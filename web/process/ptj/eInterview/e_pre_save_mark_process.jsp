<%-- 
    Document   : e_pre_save_mark_process
    Created on : Mar 7, 2016, 4:44:59 PM
    Author     : Habib
--%>
...
//        return;
//    }
    response.sendRedirect("../../../process.jsp?p=PTJ/E-Interview/e_pre_panel_start.jsp&is_refid="+is_refid+"&ipl_refid="+ipl_refid);
%>
