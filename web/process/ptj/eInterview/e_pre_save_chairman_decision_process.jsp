<%-- 
    Document   : e_pre_save_chairman_decision_process
    Created on : Mar 10, 2016, 7:42:52 PM
    Author     : Habib
--%>
...
//    }
    ...
    response.sendRedirect("../../../process.jsp?p=PTJ/E-Interview/e_pre_chairman_start.jsp&is_refid="+is_refid+"&icl_refid="+icl_refid);
%>
