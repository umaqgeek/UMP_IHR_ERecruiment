<%-- 
    Document   : e_pre_save_mark_process_uni
    Created on : Mar 26, 2016, 1:32:52 AM
    Author     : Habib
--%>
...
//        return;
//    }
    response.sendRedirect("../../../process.jsp?p=PTJ/E-Interview/e_pre_panel_start_uni.jsp&is_refid="+is_refid+"&ipl_refid="+ipl_refid+"&pph_refid="+pph_refid);
%>