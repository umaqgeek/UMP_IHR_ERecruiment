<%-- 
    Document   : e_int_save_mark_process_uni
    Created on : Mar 27, 2016, 4:37:17 AM
    Author     : Habib
--%>
...
//        return;
//    }
    response.sendRedirect("../../../process.jsp?p=BPSM/E-Interview/e_int_panel_start_uni.jsp&is_refid="+is_refid+"&ipl_refid="+ipl_refid+"&pph_refid="+pph_refid);
%>
