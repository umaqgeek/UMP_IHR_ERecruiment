<%-- 
    Document   : e_int_save_chairman_decision_process
    Created on : Feb 7, 2016, 1:19:13 AM
    Author     : Habib
--%>
...
//    }
    ...
    response.sendRedirect("../../../process.jsp?p=BPSM/E-Interview/e_int_chairman_start.jsp&is_refid="+is_refid+"&icl_refid="+icl_refid);
%>
