<%-- 
    Document   : e_int_go_interview_room_uni
    Created on : Mar 27, 2016, 4:30:37 AM
    Author     : Habib
--%>
...
String link_to_interview_room = "../../../process.jsp?p=BPSM/E-Interview/e_int_interview_room_uni.jsp"+and_is_refid+and_ipl_refid+and_pph_refid+sSize;
