...
<%
String vpp_refid = request.getParameter("vpp");
...
if (d1.size() > 0) {
    ...
    String sql2 = "INSERT INTO pos_applied(vpp_refid, c_refid, pa_dateapplied, "
            + "pa_status) "
            + "VALUES(?, ?, ?, ?) ";
    String param2[] = { vpp_refid, c_refid, pa_dateApplied, new_status };
    ...
    if (!pa_refid.equals("-1") && !pa_refid.equals("0")) {
        ...
        String sql3 = "INSERT INTO filter(pa_refid, f_status) "
                + "VALUES(?, ?) ";
        String param3[] = { pa_refid, new_status };
