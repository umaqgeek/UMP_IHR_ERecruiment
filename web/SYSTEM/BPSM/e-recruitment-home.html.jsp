                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="E-Advertisment/e-advertisment_BPSM.html.jsp">E-Advertisement (BPSM)</a>
                            </li>
                            <li>
                                <a href="#!">E-Apply</a>
                            </li>
                            <li>
                                <a href="E-Filter/e-filter_ptj.html.jsp">E-Filter</a>
                            </li>
                            <li>
                                <a href="E-Test/e-Test.html.jsp">E-Test</a>
                            </li>
                            <li>
                                <a href="E-Interview/e-Interview.html.jsp">E-Interview</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="E-Register/e-register.html.jsp">E-Register Duty</a>
                            </li>
                        </ul>
                    </li>
                    <!--<li class="active">
