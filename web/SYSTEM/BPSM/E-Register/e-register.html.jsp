        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        <a href="e-register.html.jsp"><i class="fa fa-fw fa-file"></i>E-Register Duty</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
			  ...
			  <thead>
							...
							<tbody>
								<tr>
									...
									<td>860521065246</td>
									<td></td>
									<td><a href="e-registerperonal/e-registerinformation.html.jsp">Personal profile</a></td>
								</tr>
								<tr>
									<td>2</td>
									<td>Nur Syuhada</td>
									<td>880702030574</td>
									<td></td>
									<td><p><a href="e-registerperonal/e-registerinformation.html.jsp">Personal profile</a></p></td>
								</tr>
								</tbody>
			    				</table>
                                        	  <nav>
