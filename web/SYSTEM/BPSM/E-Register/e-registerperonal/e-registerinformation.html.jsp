...
<div id="cv" class="instaFade">
	...
	<div id="mainArea" class="quickFade delayFive">
	  ...
	  <section>
        ...
        <section>
		  <div class="sectionTitle">
				<h1><input type="submit" class="styled-button-1" value="Generate CV &amp; Download" />&nbsp;
				  <input type="submit" class="styled-button-1" value="Activate" />&nbsp;
                                  <input type="submit" class="styled-button-1" value="Register" 
                                         onclick="location.href='../e-registersetup.html.jsp'" />
