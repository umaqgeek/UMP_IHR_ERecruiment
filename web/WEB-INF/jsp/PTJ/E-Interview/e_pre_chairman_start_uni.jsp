<%-- 
    Document   : e_pre_chairman_start_uni
    Created on : Mar 25, 2016, 9:33:23 PM
    Author     : Habib
--%>
...
<div class="row">
    <div class="well">
        ...
        <br/>
        <div class="row">
            <table style="background-color: white" class="table-bordered" id="candidate_list" width="100%" style="font-size: 90%">
...
//                                out.print(data_check_null_mark);
                        ...
                        if(all_submitted)
                        {
                            ...
                            {
                                %>
                                <td style="vertical-align: middle; text-align: center;"><a href="process.jsp?p=PTJ/E-Interview/e_pre_chairman_decide_uni.jsp&is_refid=<%=is_refid %>&icl_refid=<%=icl_refid %>&pph_refid=<%=data_position_list.get(a).get(0) %>" class="btn btn-danger">Decide</a></td>
                                <%
                            }
                            else
                            {
                                %>
                                <td style="vertical-align: middle; text-align: center;"><a href="process.jsp?p=PTJ/E-Interview/e_pre_chairman_decide_uni.jsp&is_refid=<%=is_refid %>&icl_refid=<%=icl_refid %>&pph_refid=<%=data_position_list.get(a).get(0) %>" class="btn btn-primary">Decide</a></td>
                                <%
                            }
                        }
                        else
        ...
        <div class="row">
            <form method="post" action="process/ptj/eInterview/e_pre_end_interview_process_uni.jsp">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a class="btn btn-warning form-control" href="process.jsp?p=PTJ/E-Interview/e_pre_my_invitation_list.jsp">OK</a>
            </div>
        </div>
        </form>
    </div>
