<%-- 
    Document   : e_pre_chairman_decide
    Created on : Mar 10, 2016, 7:03:31 PM
    Author     : Habib
--%>
...
String sql_interview_detail = "SELECT iss.is_date, iss.is_starttime, iss.is_endtime, iss.is_venue "
                            ...
                            + "WHERE iss.is_refid = ? ";
String param_interview_detail[] = { ptj_is_refid };
...
String param_cand_list[] = { ptj_is_refid, pph_refid, invite_accepted };
...
%>
<form action="process/ptj/eInterview/e_pre_save_chairman_decision_process.jsp" method="post">
<input name="is_refid" type="hidden" value="<%=ptj_is_refid %>" />
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a class="btn btn-warning form-control" href="process.jsp?p=PTJ/E-Interview/e_pre_chairman_start.jsp&is_refid=<%=ptj_is_refid %>&icl_refid=<%=icl_refid %>">OK</a>
            </div>
        </div>
        </form>
    </div>
