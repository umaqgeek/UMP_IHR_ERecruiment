<%-- 
    Document   : e_pre_panel_start
    Created on : Mar 7, 2016, 3:59:45 PM
    Author     : Habib
--%>
...
<div class="row">
    <div class="well">
        ...
        <br/>
        <div class="row">
            <form method="post" action="process/ptj/eInterview/e_pre_go_interview_room.jsp">
            ...
            for(int a = 0; a < data_cand_list.size(); a++)
            {
                ...
                <tr>
                    ...
                    {
                        %>
                        <td style="vertical-align: middle; text-align: center">DONE <a title="Edit" href="process.jsp?p=PTJ/E-Interview/e_pre_interview_room.jsp&is_refid=<%=ptj_is_refid %>&ipl_refid=<%=ipl_refid %>&selected_irm_refid0=<%=data_cand_list.get(a).get(5) %>&selected_size=1" class="glyphicon glyphicon-pencil"></a></td>
                        <%
                    }
                    %>
                </tr>
        ...
        <div class="row">
            <form method="post" action="process/ptj/eInterview/e_pre_submit_to_chairman_process.jsp">
                <%
                if(all_done)
                {
                    %>
