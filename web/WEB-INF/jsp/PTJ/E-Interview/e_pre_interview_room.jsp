<%-- 
    Document   : e_pre_interview_room
    Created on : Mar 7, 2016, 4:39:15 PM
    Author     : Habib
--%>
...
%>
<form action="process/ptj/eInterview/e_pre_save_mark_process.jsp" method="post">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a class="btn btn-warning form-control" href="process.jsp?p=PTJ/E-Interview/e_pre_panel_start.jsp&is_refid=<%=is_refid %>&ipl_refid=<%=ipl_refid %>">OK</a>
            </div>
        </div>
        </form>
    </div>
