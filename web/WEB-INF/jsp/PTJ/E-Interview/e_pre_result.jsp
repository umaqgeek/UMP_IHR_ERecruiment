<%-- 
    Document   : e_pre_result
    Created on : Feb 28, 2016, 5:34:11 PM
    Author     : Habib
--%>
...
<div class="row">
    <div class="well">
        <div class="row">
            <div class="col-sm-12"><a href="process.jsp?p=PTJ/E-Interview/e_pre_published_list.jsp" class="btn btn-default">Back</a></div>
        </div>
        <br/>
