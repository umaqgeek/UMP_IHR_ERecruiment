<%-- 
    Document   : e_pre_chairman_start
    Created on : Mar 10, 2016, 6:46:18 PM
    Author     : Habib
--%>
...
<div class="row">
    <div class="well">
                ...
                for(int a = 0; a < data_position_list.size(); a++)
                {
                    ...
                    <tr>
                        ...
                        if(all_submitted)
                        {
                            ...
                            {
                                %>
                                <td style="vertical-align: middle; text-align: center;"><a href="process.jsp?p=PTJ/E-Interview/e_pre_chairman_decide.jsp&is_refid=<%=ptj_is_refid %>&icl_refid=<%=icl_refid %>&pph_refid=<%=data_position_list.get(a).get(0) %>" class="btn btn-danger">Decide</a></td>
                                <%
                            }
                            else
                            {
                                %>
                                <td style="vertical-align: middle; text-align: center;"><a href="process.jsp?p=PTJ/E-Interview/e_pre_chairman_decide.jsp&is_refid=<%=ptj_is_refid %>&icl_refid=<%=icl_refid %>&pph_refid=<%=data_position_list.get(a).get(0) %>" class="btn btn-primary">Decide</a></td>
                                <%
                            }
                        }
                        else
        ...
        <div class="row">
            <form method="post" action="process/ptj/eInterview/e_pre_end_interview_process.jsp">
