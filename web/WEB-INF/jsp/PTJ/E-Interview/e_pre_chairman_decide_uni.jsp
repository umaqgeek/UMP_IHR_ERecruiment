<%-- 
    Document   : e_pre_chairman_decide_uni
    Created on : Mar 26, 2016, 5:31:06 AM
    Author     : Habib
--%>
...
%>
<form action="process/ptj/eInterview/e_pre_save_chairman_decision_process_uni.jsp" method="post">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a class="btn btn-warning form-control" href="process.jsp?p=PTJ/E-Interview/e_pre_chairman_start_uni.jsp&is_refid=<%=is_refid %>&icl_refid=<%=icl_refid %>">OK</a>
            </div>
        </div>
        </form>
    </div>
