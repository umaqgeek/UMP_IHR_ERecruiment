<%-- 
    Document   : e_pre_panel_start_uni_pos_list
    Created on : Mar 25, 2016, 9:36:18 PM
    Author     : Habib
--%>
            ...
            for(int a = 0; a < data_position_list.size(); a++)
            {
                ...
                <tr>
                    ...
                    <td style="vertical-align: middle; text-align: center">
                        <a class="btn btn-primary form-control" href="process.jsp?p=PTJ/E-Interview/e_pre_panel_start_uni.jsp&is_refid=<%=is_refid %>&ipl_refid=<%=ipl_refid %>&pph_refid=<%=data_position_list.get(a).get(0) %>">Start</a>
                    </td>
                </tr>
                <%
            }
