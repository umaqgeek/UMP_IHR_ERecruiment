    ...
    <div class="well">
        ...
        <div class="row">
            <ul class="nav nav-tabs">
              ...
              <li class="active">
                  <a href="process.jsp?p=BPSM/E-Interview/e_int_my_invitation_list.jsp">MY INVITATION <% 
                    ...
                    <tr>
                        ...
                        else if(data_chairman_invitation.get(a).get(7).equals(accepted))
                        {
                            if(data_chairman_invitation.get(a).get(6).equals(published))
                            {
                                ...
                                {
                                    %>
                                    <a  title="You've been accepted. Wait until interview day" class="btn btn-primary form-control" href="process.jsp?p=BPSM/E-Interview/e_int_chairman_start_uni.jsp&is_refid=<%=data_chairman_invitation.get(a).get(0) %>&icl_refid=<%=data_chairman_invitation.get(a).get(9) %>">Start</a>
                                    <%
                                }
                                else if(data_chairman_invitation.get(a).get(5).equalsIgnoreCase(ptj))
                                {
                                    %>
                                    <a  title="You've been accepted. Wait until interview day" class="btn btn-primary form-control" href="process.jsp?p=BPSM/E-Interview/e_int_chairman_start.jsp&is_refid=<%=data_chairman_invitation.get(a).get(0) %>&icl_refid=<%=data_chairman_invitation.get(a).get(9) %>">Start</a>
                                    <%
                                }
                            }
                    ...
                    <tr>
                        ...
                        else if(data_panel_invitation.get(a).get(7).equals(accepted))
                        {
                            if(data_panel_invitation.get(a).get(6).equals(published))
                            {
                                ...
                                {
                                    %>
                                    <a class="btn btn-primary form-control" href="process.jsp?p=BPSM/E-Interview/e_int_panel_start_uni_pos_list.jsp&is_refid=<%=data_panel_invitation.get(a).get(0) %>&ipl_refid=<%=data_panel_invitation.get(a).get(8) %>">Start</a>
                                    <%
                                }
                                else if(data_panel_invitation.get(a).get(5).equalsIgnoreCase(ptj))
                                {
                                    %>
                                    <a class="btn btn-primary form-control" href="process.jsp?p=BPSM/E-Interview/e_int_panel_start.jsp&is_refid=<%=data_panel_invitation.get(a).get(0) %>&ipl_refid=<%=data_panel_invitation.get(a).get(8) %>">Start</a>
                                    <%
                                }
                            }
