            ...
            <table id="invite_list" class="table-bordered" width="100%">
                <thead>
                    <tr style="vertical-align: middle;">
                        ...
                        <th colspan="3" style="vertical-align: middle; text-align: center; font-weight: bold">Pre-Interview</th>
                        <th colspan="7" style="vertical-align: middle; text-align: center; font-weight: bold">Interview</th>
                    </tr>
                    <tr style="vertical-align: middle;">
...
-->             
                    <tr>
                        ...
                        <td rowspan="3" style="vertical-align: middle">01/02/2016</td>
                        ...
                        <td rowspan="3" style="vertical-align: middle; text-align: center"><a class="btn btn-success form-control" data-toggle="modal" href="#modalPanelAccept<%//=a %>">Accept</a>
                        <a class="btn btn-warning form-control" data-toggle="modal" href="#modalPanelReject<%//=a %>">Reject</a></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle; text-align: center">Grade 1</td>
                    ...
                    <tr>
                        ...
                        <td rowspan="3" style="vertical-align: middle; text-align: center">UNIVERSITY</td>
                        <td rowspan="3" style="vertical-align: middle; text-align: center">PANEL</td>
                        <td rowspan="3" style="vertical-align: middle; text-align: center"><a class="btn btn-primary form-control" href="process.jsp?p=BPSM/E-Interview/e_int_start.jsp">Start Interview</a></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle; text-align: center">Grade 2</td>
                        <td style="vertical-align: middle">Position 1</td>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: middle">PTJ 4</td>
                    </tr>
                    <tr>
                        ...
                        <td rowspan="3" style="vertical-align: middle; text-align: center"><a class="btn btn-primary form-control" href="process.jsp?p=BPSM/E-Interview/e_int_start_chairman.jsp">Start Interview</a></td>
                    </tr>
                    <tr>
                        <td style="vertical-align: middle; text-align: center">Grade 2</td>
                        <td style="vertical-align: middle">Position 1</td>
