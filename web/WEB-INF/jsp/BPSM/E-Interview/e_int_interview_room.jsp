...
%>
<form action="process/bpsm/eInterview/e_int_save_mark_process.jsp" method="post">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a class="btn btn-warning form-control" href="process.jsp?p=BPSM/E-Interview/e_int_panel_start.jsp&is_refid=<%=is_refid %>&ipl_refid=<%=ipl_refid %>">OK</a>
            </div>
        </div>
        </form>
    </div>
