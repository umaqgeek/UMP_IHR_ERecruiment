<%-- 
    Document   : e_int_ptj_result
    Created on : Mar 25, 2016, 1:35:21 AM
    Author     : Habib
--%>
...
<%
    ...
    String prev_page = session.getAttribute("prev_page").toString();
    String accepted = "22";
    int total_mark;
    String pass = "PASS";
    String fail = "FAIL";
    ...
    String param_cand_list[] = { is_refid, data_position_list.get(0).get(0), accepted };
...
<div class="row">
    <div class="well">
        <div class="row">
            <div class="col-sm-12"><a href="process.jsp?p=<%=prev_page %>" class="btn btn-default">Back</a></div>
        </div>
        <br/>
