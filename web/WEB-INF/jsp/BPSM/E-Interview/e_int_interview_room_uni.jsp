<%-- 
    Document   : e_int_interview_room_uni
    Created on : Mar 27, 2016, 4:34:10 AM
    Author     : Habib
--%>
...
%>
<form action="process/bpsm/eInterview/e_int_save_mark_process_uni.jsp" method="post">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a class="btn btn-warning form-control" href="process.jsp?p=BPSM/E-Interview/e_int_panel_start_uni.jsp&is_refid=<%=is_refid %>&ipl_refid=<%=ipl_refid %>&pph_refid=<%=pph_refid %>">OK</a>
            </div>
        </div>
        </form>
    </div>
